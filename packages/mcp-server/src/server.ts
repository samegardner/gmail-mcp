...
import { ClientOptions } from 'gmail-mcp';
...
export { ClientOptions } from 'gmail-mcp';
...
async function getInstructions() {
  ...
  const response = await fetch(
    readEnv('CODE_MODE_INSTRUCTIONS_URL') ?? 'https://api.stainless.com/api/ai/instructions/gmail-mcp',
    {
      method: 'GET',
  ...
  if (!response.ok) {
    ...
    instructions = `
      This is the gmail-mcp MCP server. You will use Code Mode to help the user perform
