...
import { GmailMcp, ClientOptions } from 'gmail-mcp';
...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: GmailMcp)`
    : `const run: (${functionSource.client}: GmailMcp) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    ...
    'client.users.messages.getAttachment',
    'client.users.messages.list',
    'client.users.messages.retrieve',
    'client.users.messages.send',
    'client.users.messages.trash',
    'client.users.drafts.create',
    'client.users.drafts.delete',
    'client.users.drafts.list',
    'client.users.drafts.retrieve',
    'client.users.drafts.send',
